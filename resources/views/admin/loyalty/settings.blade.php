                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-xs text-gray-500">
                                    {{ trans('messages.عدد النقاط التي يحصل عليها المستخدم لكل دقيقة رحلة') }}
                                </p>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div>
                                    ...
                                    <input type="number" min="0" name="bronze_threshold" id="bronze_threshold"
                                           ...
                                           class="w-full rounded-lg border-gray-300 shadow-sm focus:border-primary focus:ring-primary">
                                    <p class="mt-1 text-xs text-gray-500">
                                        {{ trans('messages.الحد الأدنى للنقاط') }}
                                    </p>
                        ...
                        <div class="bg-amber-50 border border-amber-200 rounded-lg p-4">
                            <div class="flex items-start gap-2">
                                ...
                                <div class="text-xs text-amber-700">
                                    <strong>{{ trans('messages.Note:') }}</strong> {{ trans('messages.تأكد من أن العتبات مرتبة تصاعدياً (Bronze ≤ Silver ≤ Gold). سيتم تحديث مستويات جميع المستخدمين تلقائياً عند الحفظ.') }}
                                </div>
                            </div>
                        </div>
                    </div>
